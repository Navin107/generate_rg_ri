...
route = "ec49c89e-35c7-4554-a695-4bc8ea7bf298/.df0e0664-55cb-4035-8092-92388f9265f2"
ID = "df0e0664-55cb-4035-8092-92388f9265f2"
...
def kalyan_poi_transform(path):
    """
        Extracts vmsb locations and tranforms the data as per IUDX vocab.
...
if __name__ == "__main__":
    ...
    path = "../misc/kalyan_vmd_locations.csv"
