...
class IUDXDataProcessor:
    ...
    def generate(self):
        ...
        url = "https://cos.iudx.org.in/iudx/cat/v1/search?property=[type]&value=[[iudx:Resource]]"
...
with open("../generated_data/generate-resource-item-data-arrival-interval.jsonld", "w") as f:
